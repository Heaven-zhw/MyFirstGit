        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="list-group">
                    ...
                    <a href="toexcel.php" class="list-group-item text-center active">生成报表</a>
            ...
            <div class="col-md-9">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">生成报表</div>
                    <div class="panel-body">
                        <label class="col-sm-3 control-label">按院系导出学生信息表：</label>
                        <button class="col-sm-2 btn btn-primary" onclick="excelsinfo()">导出</button>
                        <label class="col-sm-2 control-label"></label>
                        <label class="col-sm-3 control-label">按专业导出学生成绩表：</label>
                        <button class="col-sm-2 btn btn-primary" onclick="excelsgrade()">导出</button>
                    </div>
                </div>
                <script>
                    function excelsinfo() {
                        var msg = "确定生成学生信息表？";
                        if (confirm(msg)==true){
                            var url="doAction.php?act=excelsinfo";
                            //alert(url);
                            window.location=url;
                        }else{
                            return ;
                    ...
                    function excelsgrade() {
                        var msg = "确定生成学生成绩表？";
                        if (confirm(msg)==true){
                            var url="doAction.php?act=excelsgrade";
                            //alert(url);
                            window.location=url;
                        }else{
                            return ;
